...
remaining_hammerstein_TDE_names = [
    "AT2018zr",
    "AT2018bsi",
    "AT2018hco",
    "AT2018iih",
...
hammerstein_TDE_coords = [
                ...
                (62.4068842, +73.8949048),          # NOT IN LS
                (105.8277036, +23.029083),          # NOT IN LS
                (197.689825407, +8.56785542281),
                (193.7883736, +49.5194241),
                (227.3165642, +16.2395896),
                (123.320605325, +22.648343),
                (314.2623926, +14.2044063),         # NOT IN LS
                (212.4245, +55.491139),
                (244.11582745, +56.432304066667),
                (281.317417, +44.438669), #AT2019meg
                ...
                (239.107200193, +23.3725405112), #opy
                (7.8065, +85.008861),               # NOT IN LS
                (235.063686507, +25.0013555056),
                (34.4748733233, -9.61412619912),
                (32.6281475225, +9.07408310584), #riz
                (136.357833, +61.80255),
                (335.571375, -7.266411),

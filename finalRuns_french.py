...
from download_data import french_TDE_coords, french_TDE_names
...
def fit_bunch_of_sersics(bands="r", type="None", objIDs=range(len(french_TDE_names)), psf_band=None, radius=60, nsigma=15, exp_size=1):
    coords = french_TDE_coords
    path_section = "french_tde"
...
def fit_bulge_disk(bands="r", type="None", objIDs=range(len(french_TDE_names)), psf_band=None, fixed_n_list=None, fixed_center=None, exp_size=1, nsigma=15, radius=60, fitting_level="mega_deep", writeError=False):
    coords = french_TDE_coords
    path_section = "french_tde"
    names = french_TDE_names
...
if __name__ == "__main__":
    ...
    #fit_bulge_disk(bands="z", type="Bulge", nsigma=5, objIDs=[1], psf_band="z")

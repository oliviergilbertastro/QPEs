...
fit_sepc.prepare_fitting_seq(point_source_num = 0, fix_n_list= [[3.]], fix_center_list = None, 
                            extend_source_model=["GAUSSIAN_ELLIPSE"], source_params = None, ps_params = None)

...
fit_sepc.prepare_fitting_seq(point_source_num = 1, fix_n_list= None,condition=condition_bulgedisk)
...
fit_run = FittingProcess(fit_sepc, savename = 'ra19.7861250_dec-34.1916944_bulgeAGN', fitting_level='deep') 

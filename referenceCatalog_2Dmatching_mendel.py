...
np.savetxt("referenceCatalog_final_mendel.txt", goodGalaxies)
refCat = np.loadtxt("referenceCatalog_final_mendel.txt")
fieldnames = [f"col_{i}" for i in range(refCat.shape[1])]
fieldnames[1] = "redshift"
fieldnames[63] = "m_star"
fieldnames[67] = "m_bh"
refCat = pd.read_csv("referenceCatalog_final_mendel.txt", delimiter=" ", header=None, names=fieldnames)
